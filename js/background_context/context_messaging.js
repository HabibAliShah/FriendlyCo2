...
function handle_request ( message, sender, sendResponse ) 
{
    ...
    switch ( method ) 
    {
        /** ----- THESE ARE JUST FROM EXTENSION FRAMEWORK: ------
         *  
         */
            case "SET_BADGE" :
        ...
        /** ----- FOR CARBONALYSER FUNCTIONALITY: -----
         *  
         */
            case "START_CARBONALYSER_ANALYSIS" : 
            {
                sendResponse( "ok, Carbonalyser analysis running." );
                START_CARBONALYSER_ANALYSIS(); // reference in -> /carbonalyser/index.js
                break;
            }
            case "STOP_CARBONALYSER_ANALYSIS" : 
            {
                sendResponse( "ok, Carbonalyser analysis stopped." );
                STOP_CARBONALYSER_ANALYSIS(); // reference in -> /carbonalyser/index.js
                break;
            }
        /* ----------------------------------------------------- */
    };
